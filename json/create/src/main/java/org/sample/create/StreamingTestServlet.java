 ...
 * @author Arun Gupta
 */
@WebServlet(urlPatterns = {"/StreamingTestServlet"})
...
//            gen.close();
            ...
            out.println("<br>Creating a simple object (using streaming generator)...<br>");
...
//            gen.close();
            ...
            out.println("<br>Creating a nested structure (using streaming generator)...<br>");
            gen = factory.createGenerator(out);
            gen
                .writeStartArray()
                    .writeStartObject()
